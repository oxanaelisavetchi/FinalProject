...
import static com.automation.project.actions.ApiRequest.*;
import static io.restassured.RestAssured.given;
import static org.hamcrest.Matchers.is;


public class RestApiStep {
    private static final Logger log = LoggerFactory.getLogger(RestApiStep.class);
    ...
    public void aGetRequestIsSentToTheEndpoint(String urlKey) {
        ApiPath apiPath = ApiPath.valueOf(urlKey);
